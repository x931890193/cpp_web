...
MSGPACK_PREDEF_DECLARE_TEST(MSGPACK_ENDIAN_BIG_BYTE,
MSGPACK_ENDIAN_BIG_BYTE_NAME)

#include <msgpack/predef/detail/test.h>

MSGPACK_PREDEF_DECLARE_TEST(MSGPACK_ENDIAN_BIG_WORD,
MSGPACK_ENDIAN_BIG_WORD_NAME)

#include <msgpack/predef/detail/test.h>

MSGPACK_PREDEF_DECLARE_TEST(MSGPACK_ENDIAN_LITTLE_BYTE,
MSGPACK_ENDIAN_LITTLE_BYTE_NAME)

#include <msgpack/predef/detail/test.h>

MSGPACK_PREDEF_DECLARE_TEST(MSGPACK_ENDIAN_LITTLE_WORD,
