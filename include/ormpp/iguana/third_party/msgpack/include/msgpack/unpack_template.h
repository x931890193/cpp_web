...
msgpack_unpack_func(void, _init)
...
*/
ctx->stack[0].
obj = msgpack_unpack_callback(_root)(&ctx->user);
}
...
msgpack_unpack_func(msgpack_unpack_object, _data
)(
msgpack_unpack_struct(_context)
* ctx)
{
...
_msgpack_load32(uint32_t, n, &mem
.i);
...
_msgpack_load64(uint64_t, n, &mem
.i);
