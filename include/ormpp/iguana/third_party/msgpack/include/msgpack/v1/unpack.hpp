            ...
            namespace detail {
                ...
                struct unpack_array {
                    void operator()(unpack_user &u, uint32_t n, msgpack::object &o) const {
                        ...
                        o.via.array.size = 0;
                        o.via.array.ptr = static_cast<msgpack::object *>(u.zone().allocate_align(
                                n * sizeof(msgpack::object)));
                    }
                };
                ...
                struct unpack_map {
                    void operator()(unpack_user &u, uint32_t n, msgpack::object &o) const {
                        ...
                        o.via.map.size = 0;
                        o.via.map.ptr = static_cast<msgpack::object_kv *>(u.zone().allocate_align(
                                n * sizeof(msgpack::object_kv)));
                    }
                };
                ...
                template<typename T>
                inline typename msgpack::enable_if<sizeof(T) == sizeof(fix_tag)>::type
                load(uint32_t &dst, const char *n) {
...
/// Unpacking class for a stream deserialization.
            class unpacker {
                 ...
                 *
                 */
                unpacker(unpack_reference_func
                f = &unpacker::default_reference_func,
                        void * user_data = nullptr,
                        std::size_t
                initial_buffer_size = MSGPACK_UNPACKER_INIT_BUFFER_SIZE,
                        unpack_limit const&limit = unpack_limit());
