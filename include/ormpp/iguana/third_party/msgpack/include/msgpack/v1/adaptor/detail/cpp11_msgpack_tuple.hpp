...
// --- Convert from tuple to object ---
            ...
            struct MsgpackTupleConverter {
                static void convert(
                    ...
                    o.via.array.ptr[N - 1].convert<typename std::remove_reference<decltype(type::get<N - 1>(v))>::type>(
                            type::get<N - 1>(v));
                }
            };
            ...
            struct MsgpackTupleConverter<Tuple, 1> {
                static void convert(
                        msgpack::object const &o,
                        Tuple &v) {
                    o.via.array.ptr[0].convert<typename std::remove_reference<decltype(type::get<0>(v))>::type>(
                            type::get<0>(v));
                }
            };
                ...
                struct object_with_zone<msgpack::type::tuple<Args...>> {
                    void operator()(
                        ...
                        o.via.array.ptr = static_cast<msgpack::object *>(o.zone.allocate_align(
                                sizeof(msgpack::object) * sizeof...(Args)));
