...
/// @endcond
            ...
            namespace adaptor {
                ...
                struct convert<std::unordered_set<Key, Hash, Compare, Alloc>> {
                    ...
                    operator()(msgpack::object const &o, std::unordered_set<Key, Hash, Compare, Alloc> &v) const {
                        if (o.type != msgpack::type::ARRAY) { throw msgpack::type_error(); }
                        msgpack::object *p = o.via.array.ptr + o.via.array.size;
                        msgpack::object *const pbegin = o.via.array.ptr;
                ...
                struct pack<std::unordered_set<Key, Hash, Compare, Alloc>> {
                    ...
                    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                        ...
                        o.pack_array(size);
                        for (typename std::unordered_set<Key, Hash, Compare, Alloc>::const_iterator it(
                ...
                struct convert<std::unordered_multiset<Key, Hash, Compare, Alloc>> {
                    msgpack::object const &
                    operator()(msgpack::object const &o, std::unordered_multiset<Key, Hash, Compare, Alloc> &v) const {
                        if (o.type != msgpack::type::ARRAY) { throw msgpack::type_error(); }
                        msgpack::object *p = o.via.array.ptr + o.via.array.size;
                        msgpack::object *const pbegin = o.via.array.ptr;
                ...
                struct pack<std::unordered_multiset<Key, Hash, Compare, Alloc>> {
                    ...
                    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                        ...
                        uint32_t size = checked_get_container_size(v.size());
                        o.pack_array(size);
                        for (typename std::unordered_multiset<Key, Hash, Compare, Alloc>::const_iterator it(
                                v.begin()), it_end(v.end());
                             it != it_end; ++it) {
                            o.pack(*it);
                        }
