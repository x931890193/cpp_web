            ...
            namespace adaptor {
                ...
                struct pack<MSGPACK_STD_TR1::unordered_map < K, V, Hash, Pred, Alloc> > {
                    ...
                    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                        ...
                        o.pack_map(size);
                        for (typename MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc>::const_iterator it(
                ...
                struct object_with_zone<MSGPACK_STD_TR1::unordered_map < K, V, Hash, Pred, Alloc> > {
                    void operator()(msgpack::object::with_zone &o,
                        ...
                        if (v.empty()) {
                            ...
                            o.via.map.ptr = p;
                            o.via.map.size = size;
                            typename MSGPACK_STD_TR1::unordered_map<K, V, Hash, Pred, Alloc>::const_iterator it(
                                    v.begin());
                            do {
                ...
                struct pack<MSGPACK_STD_TR1::unordered_multimap < K, V, Hash, Pred, Alloc> > {
                    ...
                    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                        ...
                        uint32_t size = checked_get_container_size(v.size());
                        o.pack_map(size);
                        for (typename MSGPACK_STD_TR1::unordered_multimap<K, V, Hash, Pred, Alloc>::const_iterator it(
                                v.begin()), it_end(v.end());
                             it != it_end; ++it) {
                            o.pack(it->first);
                            o.pack(it->second);
                ...
                struct object_with_zone<MSGPACK_STD_TR1::unordered_multimap < K, V, Hash, Pred, Alloc> > {
                    void operator()(msgpack::object::with_zone &o,
                        ...
                        if (v.empty()) {
                            ...
                            o.via.map.ptr = p;
                            o.via.map.size = size;
                            typename MSGPACK_STD_TR1::unordered_multimap<K, V, Hash, Pred, Alloc>::const_iterator it(
                                    v.begin());
                            do {
                                p->key = msgpack::object(it->first, o.zone);
                                p->val = msgpack::object(it->second, o.zone);
