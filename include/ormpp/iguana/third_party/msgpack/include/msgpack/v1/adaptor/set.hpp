...
/// @endcond
            ...
            namespace adaptor {
                ...
                struct pack<std::set<T, Compare, Alloc> > {
                    ...
                    operator()(msgpack::packer<Stream> &o, const std::set<T, Compare, Alloc> &v) const {
                ...
                struct convert<std::multiset<T, Compare, Alloc> > {
                    ...
                    operator()(msgpack::object const &o, std::multiset<T, Compare, Alloc> &v) const {
                        if (o.type != msgpack::type::ARRAY) { throw msgpack::type_error(); }
                        msgpack::object *p = o.via.array.ptr + o.via.array.size;
                        msgpack::object *const pbegin = o.via.array.ptr;
                ...
                struct pack<std::multiset<T, Compare, Alloc> > {
                    template<typename Stream>
                    msgpack::packer<Stream> &
                    operator()(msgpack::packer<Stream> &o, const std::multiset<T, Compare, Alloc> &v) const {
                        uint32_t size = checked_get_container_size(v.size());
                        o.pack_array(size);
