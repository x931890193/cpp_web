            ...
            namespace adaptor {
                ...
                struct pack<MSGPACK_STD_TR1::unordered_set < T, Hash, Compare, Alloc> > {
                    ...
                    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                        ...
                        o.pack_array(size);
                        for (typename MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc>::const_iterator it(
                ...
                struct object_with_zone<MSGPACK_STD_TR1::unordered_set < T, Hash, Compare, Alloc> > {
                    void operator()(msgpack::object::with_zone &o,
                        ...
                        if (v.empty()) {
                            ...
                            uint32_t size = checked_get_container_size(v.size());
                            msgpack::object *p = static_cast<msgpack::object *>(o.zone.allocate_align(
                                    sizeof(msgpack::object) * size));
                            msgpack::object *const pend = p + size;
                            o.via.array.ptr = p;
                            o.via.array.size = size;
                            typename MSGPACK_STD_TR1::unordered_set<T, Hash, Compare, Alloc>::const_iterator it(
                                    v.begin());
                            do {
                ...
                struct pack<MSGPACK_STD_TR1::unordered_multiset < T, Hash, Compare, Alloc> > {
                    ...
                    msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                        ...
                        uint32_t size = checked_get_container_size(v.size());
                        o.pack_array(size);
                        for (typename MSGPACK_STD_TR1::unordered_multiset<T, Hash, Compare, Alloc>::const_iterator it(
                                v.begin()), it_end(v.end());
                             it != it_end; ++it) {
                            o.pack(*it);
                        }
                ...
                struct object_with_zone<MSGPACK_STD_TR1::unordered_multiset < T, Hash, Compare, Alloc> > {
                    void operator()(msgpack::object::with_zone &o,
                        ...
                        if (v.empty()) {
                            ...
                            o.via.array.ptr = p;
                            o.via.array.size = size;
                            typename MSGPACK_STD_TR1::unordered_multiset<T, Hash, Compare, Alloc>::const_iterator it(
                                    v.begin());
                            do {
                                *p = msgpack::object(*it, o.zone);
                                ++p;
