...
/// The class holds object and zone
            class object_handle {
                 ...
                 * @param z zone
                 */
                object_handle(msgpack::object const&obj, msgpack::unique_ptr<msgpack::zone>
                z) :
                        ...
                        switch (v.type) {
                            ...
                            case msgpack::type::ARRAY:
                                o.via.array.ptr = static_cast<msgpack::object *>(o.zone.allocate_align(
                                        sizeof(msgpack::object) * v.via.array.size));
                            ...
                            case msgpack::type::MAP:
                                o.via.map.ptr = (msgpack::object_kv *) o.zone.allocate_align(
                                        sizeof(msgpack::object_kv) * v.via.map.size);
